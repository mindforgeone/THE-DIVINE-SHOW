...
export function memberCommitmentsForDuration(durationDays = 120) {
  ...
  return [
    ...
    { id: 'rules', title: 'Настроить правила дня', metric: 'Только мои измеримые правила', text: 'Я могу добавить, скрыть или завершить правило. История останется в статистике с даты, когда правило действовало.' },
